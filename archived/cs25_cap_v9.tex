...
$B_{\rm ap}(a)$.  \Cref{sec:aperiodic-hankel-certificates} now supplies the
contributor-facing chart atlas: regular overdetermined minors, affine pivots,
projective-infinity charts, and curve coefficient pivots.  The remaining proof
problem is to construct small eliminants for these charts, or to classify the
singular residual buckets as quotient, tangent, extension-field exceptional, or
genuinely new.
