...
bound to the weighted mass.  Finally, an exact generated-field descent shows
that the seven non-generating degree/order types have the same final block
census and kernel mass as three generating types.
...
sufficient supplier for both branches.  Corollary~\ref{cor:distance}
controls low-weight words but not the
