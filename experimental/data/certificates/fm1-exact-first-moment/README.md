...
- `fm1_exact_first_moment.json` records the F_13 rank/surjectivity check, the
  ...
  slack-one variance check, the F_5 brute-force first- and second-moment
  enumeration check, the Paley-Zygmund averaged-existence consumer, and the
  F_17^32 regular-window Markov consumer scale.
