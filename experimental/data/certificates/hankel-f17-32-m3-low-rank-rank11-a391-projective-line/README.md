# F17^32 M3 Rank-11 A391 Projective-Line Packet

This directory contains a v9 projective-line regular-minor packet for the
synthetic rank-11 low-rank M3 row at `A=391`.
...
python3 scripts/check_aperiodic_eliminant_packet.py \
  experimental/data/certificates/hankel-f17-32-m3-low-rank-rank11-a391-projective-line/f17_32_n512_k256_a391_rank11_projective_line_packet.json
```

The source rank-9..11 sweep stores this row compactly by hashes.  The packet
generator recomputes the degree-11 regular minor, checks its coefficient and
...
`11+1=12`, above the M3 budget numerator `6`; the exact projective-line
