# F17^32 M3 Low-Rank2-8 v10 Affine GCD Certificate

This directory contains a standalone Paper D v10 affine rank-drop certificate
for the synthetic low-rank M3 ladder at ranks `2..8` over the accepted row
...
For each of the `294` rank/agreement rows, the verifier displays two maximal
...
```sh
python3 experimental/scripts/verify_f17_32_m3_low_rank2_8_v10_affine_gcd.py \
  --write experimental/data/certificates/hankel-f17-32-m3-low-rank2-8-v10-affine-gcd/f17_32_n512_k256_m3_low_rank2_8_v10_affine_gcd.json

python3 experimental/scripts/verify_f17_32_m3_low_rank2_8_v10_affine_gcd.py \
  --check experimental/data/certificates/hankel-f17-32-m3-low-rank2-8-v10-affine-gcd/f17_32_n512_k256_m3_low_rank2_8_v10_affine_gcd.json
```
