...
rank-2..11 endpoint quotient-support audit.  Version `v3` also consumes the
rank-6..11 shifted-minor exclusion.
...
is excluded from all nontrivial proper quotient-remainder support families;
finite regular-root quotient support and quotient image are explicitly recorded
as `not_audited`.
