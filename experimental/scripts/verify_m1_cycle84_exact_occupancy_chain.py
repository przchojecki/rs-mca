...
52,747,567,092, true ordered energy 24, and m_max=2, conditional on source-code
review of the generated full replay.
"""
...
def build_report() -> Dict[str, Any]:
    ...
    return {
        ...
        "checks": checks,
        "remaining_import": (
            "human review that the generated Cycle84 C++ replay source follows "
            "the audited algorithm"
        ),
        "imports_required": [
