...
void write_report(const std::string& path, const std::vector<Result>& results) {
    ...
    output << "{\n"
           << "  \"schema\": \"sp01zxa8-support-six-partition-sieve/v1\",\n"
           << "  \"claim_id\": \"SP01ZXA8_EXACT_SUPPORT_SIX_PARTITION_SIEVE\",\n"
           << "  \"status\": \"PASS_EXACT_SUPPORT_SIX_EXCLUSION\",\n"
           << "  \"field\": " << P << ",\n"
...
#pragma omp parallel for schedule(dynamic, 1)
        ...
        std::cout << "PASS SP01zxa8 exact support-six partition sieve\n";
        return 0;
