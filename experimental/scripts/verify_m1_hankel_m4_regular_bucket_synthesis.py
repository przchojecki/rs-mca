...
SCHEMA_VERSION = "f17-32-m3-m4-regular-bucket-synthesis-v18"
Q_LINE = 17**32
TARGET_BITS = 128
...
EXPECTED_SCHEMAS = {
    ...
    A386_MOVING_SLOPE_REF: "f17-32-m3-rank6-a386-moving-slope-split-incidence-v36",
}
    ...
    require(
        [
            (
                ...
                (
                    row["private_rank_obstruction"]["rank_capacity_check"]["max_edges"]
        ...
        == [
            *[
                (
                    ...
                    3 if core <= 114 else 6,
                    "two_private_coordinate_signed_edge"
                    if core <= 114
                    else "one_private_coordinate",
                    3 if core <= 114 else None,
                )
    ...
    return {
        ...
        "synthesis": {
            ...
            "a386_moving_slope_refinement": [
                ...
                "the exact-agreement residual-budget split closes the cofactor-current tangent tail e_G=109..119 for lines and e_G=115..119 for irreducible conics by cofactor rank; the d=r'+2 two-private-coordinate signed-edge branch closes lines and reduces conics e_G=109..114 to a K4 boundary",
