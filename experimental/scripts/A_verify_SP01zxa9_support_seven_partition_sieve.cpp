...
void write_report(const std::string& path, const std::vector<Result>& results) {
    ...
    output << "{\n"
           << "  \"schema\": \"sp01zxa9-support-seven-partition-sieve/v1\",\n"
           << "  \"claim_id\": \"SP01ZXA9_EXACT_SUPPORT_SEVEN_PARTITION_SIEVE\",\n"
           << "  \"status\": \"PASS_EXACT_SUPPORT_SEVEN_EXCLUSION\",\n"
           << "  \"field\": " << P << ",\n"
...
#pragma omp parallel for schedule(dynamic, 1)
        ...
        std::cout << "PASS SP01zxa9 exact support-seven partition sieve\n";
        return 0;
