...
python3 experimental/scripts/m1_density_budget.py --q 17 --D 2 --L 3 --baseline-a0 --target-R 5 --scan-targets-up-to 5 --e 4 --quartic-window --quartic-m 7 --residual-m 7 --pretty
