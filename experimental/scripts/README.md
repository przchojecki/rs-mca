...
python3 experimental/scripts/verify_c9_literal_interface_counterexample_v1.py --check
python3 experimental/scripts/verify_c9_literal_interface_counterexample_v1.py --tamper-selftest
```
