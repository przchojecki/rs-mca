...
also eliminates kernel-lane domination through $K'=4598$, but not above
the printed $4599$ method wall.
...
$10\le K'\le4598$, rank eight plus kernel on $4599\le K'\le22525$,
dense-owner chronology plus kernel on $22526\le K'\le37995$, and kernel
only above.
