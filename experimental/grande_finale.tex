...
removes the shortest row. Thus the remaining intervals are rank eight only on
$11\le K'\le22525$, dense-owner chronology only on
...
dimension at least three.  Summing fixed-chart caps without retaining owner
