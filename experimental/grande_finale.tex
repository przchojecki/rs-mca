...
$22\le K'\le83$, rank nine or rank eight on $84\le K'\le15528$, rank
...
At the first remaining rank-nine row $K'=84$, no closure is asserted here.
...
payment.  No extrapolation from the exact $K'=83$ row is used.
