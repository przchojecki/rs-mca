...
Thus the remaining intervals are rank nine or rank eight on
$22\le K'\le15528$, rank eight only on $15529\le K'\le22525$,
...
At the first remaining row $K'=22$, the joint sparse-shadow formula has the
printed capacity excess
$2859529280846211417198922209345618432657212793529140162369036$.
This is a method wall: a continuation must lower the sparse completion
premium or extract another shared resource without omitting a kernel
