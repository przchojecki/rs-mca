...
Assume that every official corank-three shortened chart satisfies the
uniform record cap $M_3\le983902549$.
...
complete-chart corank-three cap.  Conditional only on uniform promotion of
the corank-three cap,
...
$37996\le K'\le568338$, and kernel only on
$568339\le K'\le1048576$.  The remaining conditional capacity replay
describes what the same ledger would prove if its corank-three uniform-cap
premise were established; it does not shrink this unconditional kernel
interval.
