...
still.  This proves only a method wall: a stronger nonseparable
triple-carrier census may close $K'=83$.
\end{proof}
...
$22\le K'\le82$, rank nine or rank eight on $83\le K'\le15528$, rank
...
At the first remaining rank-nine row $K'=83$, no closure is asserted here.
The surviving $(23,24,24,25)$ cell requires a nonseparable triple-carrier
support-three/support-four/support-five census.  The complete pairwise
atlas, its forced four-dimensional Grassmann intersection, and the
branch-free baseline have all been replayed and fail.  No extrapolation from
the preceding exact rows is used.
