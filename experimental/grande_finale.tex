...
floor. Proposition~\ref{prop:kb-rank11-kernel-basis-capacity}
...
removes rank eight from the shortest row. Thus the remaining intervals are
rank nine only at $K'=10$, rank nine or rank eight on
$11\le K'\le15634$, rank eight only on $15635\le K'\le22525$,
