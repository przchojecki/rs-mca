...
$K'=84$ by an independent exact-row continuation.
Thus the remaining intervals are rank eight only on
$22\le K'\le84$, rank nine or rank eight on $85\le K'\le15528$, rank
...
At the first remaining rank-nine row $K'=85$, no closure is asserted here.
...
payments.  No extrapolation from either exact row is used.
