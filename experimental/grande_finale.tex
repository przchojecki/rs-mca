...
$22\le K'\le71$, rank nine or rank eight on $72\le K'\le15528$, rank
...
At the first remaining rank-nine row $K'=72$, the exact carrier-trichotomy
payment has the printed capacity excess
$4821537739796415753639473905341364357966460110033651367468100$.
Here the active defects have $M_3=M_2+2$, beyond the one-step carrier
trichotomy.  This is a method wall: a continuation must sharpen the complete weighted
deficit vector, lower the rank-nine chart, or extract another shared resource without omitting a kernel
corank or reusing a rank-nine mark.
