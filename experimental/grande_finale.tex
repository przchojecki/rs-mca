...
\[
 ...
 \ge67452=m-2.
\]
Thus the first residue-zero obstruction is reduced to the one- and
two-private-coordinate line strata.  This is a structural router, not a
safety or unsafety certificate at $e=98232$, and the Mersenne residual
interval remains $98232\le e\le1044241$.  The exact replay is in
...
\text{KoalaBear}&14&15&e\le64047\ \text{or}\ e\ge1044239\\
\text{Mersenne-31}&6&6&e\le65454\ \text{or}\ e\ge1037876\\
\text{Mersenne-31}&6&7&e\le65454\ \text{or}\ e\ge1044242
\end{array}
\]
The improvement is only in the \(h=K\) rows.  The full-lift \(h=K+1\)
middle intervals remain unpaid and are the wider top-rank residuals.
After \cref{cor:mean-centered-sparse-direction-profile}, those full-lift
intervals are exactly \(64048\le e\le1044238\) for KoalaBear and
\(65455\le e\le1044241\) for Mersenne-31.
...
\begin{remark}[Retraction of the active affine-span MCA payments]
...
expression, but they are not upper bounds for MCA slope families.  No
affine-rank lower wall for a surviving MCA chart is claimed here.  The
ordinary affine-span list payments immediately above are unaffected.
\end{remark}
