...
still bounded by \(\mathrm{FamilyBudget}_{hw}\) alone, since the overlap
systems are subsets of the same family-labelled tail.  The overlap-separation
term is used to remove cross-family intersections before
