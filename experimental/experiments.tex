...
\[
  \mathrm{HybridOverlap}_{hw}+\mathrm{FamilyBudget}_{hw}+2h.
\]
...
systems are subsets of the same family-labelled tail.  The hybrid overlap term
is a separation charge used to remove cross-family intersections before
