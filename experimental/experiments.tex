...
image of the active locator family.  In the ruled part, the common-kernel
branch has a fixed projective boundary slope, while the common-image branch
forces the shadow locator \(L_S\) to satisfy the lower and upper row-cut
equations obtained by contracting both Hankel windows against the annihilator
of the common image line.  Thus the boundary residual is split into a
shadow-expansion problem and a row-cut resonance problem.
