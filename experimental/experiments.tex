...
negative-parity square-norm branch is isolated, positive-parity square norm
satisfies \((e-2)|D|+C_e\sqrt p+O_e(1)\), geometrically integral genus-one
branches satisfy \((1-1/e)|D|+C_e\sqrt p+O_e(1)\), geometrically integral
rational cubic branches satisfy \(|D|+C_e\sqrt p+O_e(1)\), and split-square
rational branches satisfy \(2(1-1/e)|D|+C_e\sqrt p+O_e(1)\).  The index-two
nonsplit case away from the two square gates has the sharper
\(|D|/2+C\sqrt p+O(1)\) bound above.
