...
closure.  Its exact next theorem is the local bound \(215792\), or an
equivalent fixed-support divisor-direction cap \(15413\), or an
owner-preserving injection of all such decorated neighbors into already paid
cells with exact add-back.
