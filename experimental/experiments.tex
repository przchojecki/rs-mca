...
constant-norm and square-norm exceptions are removed,
\[
  N_R^{+,-}(D)
  \le {e+1\over e^2}|C_R^\times|+C_e\sqrt p+O_e(1)
  \le (1+1/e)|D|+C_e\sqrt p+O_e(1)
\]
...
after fixed-zero-root, constant-norm, and square-norm branches are charged or
isolated, geometrically integral genus-one branches satisfy
\((1-1/e)|D|+C_e\sqrt p+O_e(1)\), geometrically integral rational cubic
branches satisfy \((1+1/e)|D|+C_e\sqrt p+O_e(1)\), and split-square rational
branches satisfy \(2(1-1/e)|D|+C_e\sqrt p+O_e(1)\).  The index-two nonsplit
case away from the two square gates has the sharper \(|D|/2+C\sqrt p+O(1)\)
bound above.
