...
it does not remove the overlap-separation charge, because that charge concerns
actual cross-family overlap systems rather than the ambient divisor-subspace
union.
...
degrees are large, or remove the overlap-separation charge.
