...
the proof-separation ledger in Corollary 40.33 remains
`OverlapSep_hw + FamilyBudget_hw`, because it charges actual overlap systems
before applying the family-disjoint closure.
...
degrees are large, or replace the proof-separation ledger.
