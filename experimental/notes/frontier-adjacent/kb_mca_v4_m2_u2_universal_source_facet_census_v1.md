...
degree-eight `J_1`-slice identity (9.24).
...
(9.18) with the finite reconstructions from (9.23). Apply (9.24) before
forming either degree-six partial resultant; route the 123
